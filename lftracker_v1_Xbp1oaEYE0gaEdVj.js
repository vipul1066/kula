! function() {
    ...
    var n, t, e, i, w = "Xbp1oaEYE0gaEdVj",
        a = "2.59.0",
    ...
    if ("undefined" != typeof window && void 0 !== window.ldfdr) {
        ...
        n = window.ldfdr, t = w, e = a, i = s, n.setTrackerOption(t, "lfaCookieEnabled", !0, i.enableCookie), n.setTrackerOption(t, "consentManagementEnabled", !1, i.enableCm), n.setTrackerOption(t, "useSendBeaconApi", !1, i.useBeacon), n.setTrackerOption(t, "autoTrackingMode", "spa", i.atMode), n.setTrackerOption(t, "foreignCookieSettings", {
    ...
    un() && an().registerPlugin(w, "discover", function() {
        ...
        var r = 500,
            f = ["button", "hidden", "image", "password", "reset", "submit"],
            i = 0,
            o = an().getTracker(w),
            s = function(n) {
        ...
        function c(n, t) {
            if (!(u(n) || i + r >= (new Date).getTime())) {
                var e = function(n) {
                    for (var t = {}, e = n.elements, r = s.fields ? s.fields.filter(function(n) {
                            return !!n.lfProperty
                        }) : [], i = 0; i < e.length; i++) {
                        var o = e[i],
                            a = o.name;
                        if (a && !(0 <= f.indexOf(o.type)) && (t[a] = {
                                name: a,
                                type: o.type
                            }, void 0, "text" !== (c = o.type) && "email" !== c && c || !xt(o.value) || (t[a].suggestedLfProperty = "email"), l(n, o))) {
                            t[a].value = o.value;
                            var u = g(o, r);
                            u && (t[a].lfProperty = u)
                        }
    ...
    function ot(t, e) {
        ! function(n) {
            ...
            var n = Hn(st(), t);
            !0 === Wn().useSendBeaconApi && navigator && navigator.sendBeacon ? (Qn("https://tr.lfeeder.com", n, e), Xn() && Qn("https://tr2.lfeeder.com", n)) : (nt("https://tr.lfeeder.com", n, e), Xn() && nt("https://tr2.lfeeder.com", n))
        })
    }
    ...
    function Rt(n, t) {
        t = t ? t++ : 1, window.MutationObserver && (10 <= t || (document.body ? new MutationObserver(Lt(n, 100, {
            ...
            childList: !0,
            subtree: !0
        }) : setTimeout(Rt.bind(null, n, t), 100)))
    }
    if (un()) {
        location.href;
        var Mt = (function(n) {
        ...
        "disabled" === Mt.autoTrackingMode || "on_script_load" === Mt.autoTrackingMode && !1 === Mt.enableAutoTracking || Mt.pageview({}, function() {
